...
![https://github.com/heibaiying](../pictures/hive-hadoop-partitation.png)
...
![https://github.com/heibaiying](../pictures/hive-hadoop-mapreducer.png)

### 1.5 查看分桶文件

bucket(桶) 本质上就是表目录下的具体文件：

![https://github.com/heibaiying](../pictures/hive-hadoop-bucket.png)
