...
![https://github.com/heibaiying](../pictures/flink-stateful-stream.png)
...
![https://github.com/heibaiying](../pictures/flink-operator-state.png)
...
![https://github.com/heibaiying](../pictures/flink-keyed-state.png)
...
![https://github.com/heibaiying](../pictures/flink-state-management.png)
...
![https://github.com/heibaiying](../pictures/flink-operator-state-para1.png)



在上面的调用代码中，我们将程序的并行度设置为 1，可以看到三次输出中状态实例的 hashcode 全是一致的，证明它们都同一个状态实例。假设将并行度设置为 2，此时输出如下：

![https://github.com/heibaiying](../pictures/flink-operator-state-para2.png)
...
![https://github.com/heibaiying](../pictures/flink-stream-barriers.png)
...
![https://github.com/heibaiying](../pictures/flink-checkpoints-backend.png)
