...
![https://github.com/heibaiying](../pictures/flink-RichParallelSourceFunction.png)
...
![https://github.com/heibaiying](../pictures/flink-kafka-datasource-producer.png)
程序控制台的输出如下：

![https://github.com/heibaiying](../pictures/flink-kafka-datasource-console.png)
可以看到已经成功接收并打印出相关的数据。
