...
![https://github.com/heibaiying](../pictures/hbase-coprocessor.png)

这里以 `RegionObservers ` 为例，其接口类中定义了所有可用的钩子方法，下面截取了部分方法的定义，多数方法都是成对出现的，有 `pre` 就有 `post`：

![https://github.com/heibaiying](../pictures/RegionObserver.png)

</br>

#### 4. 执行流程

![https://github.com/heibaiying](../pictures/RegionObservers-works.png)
...
![https://github.com/heibaiying](../pictures/hbase-cp-hdfs.png)
...
![https://github.com/heibaiying](../pictures/hbase-cp-load.png)
...
![https://github.com/heibaiying](../pictures/hbase-cp-helloworld.png)
...
![https://github.com/heibaiying](../pictures/hbase-cp-lisi.png)
...
![https://github.com/heibaiying](../pictures/hbase-co-unload.png)
...
![https://github.com/heibaiying](../pictures/hbase-unload-test.png)
